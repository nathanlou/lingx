		...
		<div class="container_table">
			 ...
			 style="width: 100%;font-size: 13px;" :default-sort="{prop: 'date', order: 'descending'}">
				...
				<el-table-column label="操作" align="center">
					<template slot-scope="scope">
						<el-button type="danger" size="mini" @click="xiugai(scope.$index, scope.row)">修改</el-button>
					</template>
				</el-table-column>
			</el-table>
			...
			<el-dialog title="修改系统参数" :visible.sync="czmmdialog" width="30%">
				<el-form ref="ruleForm"  status-icon  label-width="100px" class="demo-ruleForm">
					<el-form-item label="属性名" prop="age">
						{{ name }}
					</el-form-item>
					<el-form-item label="类型" prop="pass">
						{{style}}
					</el-form-item>
					<el-form-item label="属性值" prop="checkPass">
				...
				<span slot="footer" class="dialog-footer">
					...
					<el-button type="primary" @click="submitForm(index)">确 定</el-button>
				</span>
			</el-dialog>
			<!-- socket -->
		</div>
